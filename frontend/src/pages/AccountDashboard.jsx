                      ...
                      {scheduleEditMode ? (
                        <>
                          <button
                            ...
                            className={`px-3 sm:px-6 py-2 sm:py-2.5 text-white text-sm sm:text-base font-bold rounded-lg transition-all duration-200 shadow-lg flex items-center gap-1.5 sm:gap-2 ${
                              scheduleSaving 
                        ...
                        {days.filter(day => day !== 'Sunday').map(day => {
                          ...
                          return (
                            <button
                              ...
                              className={`group px-4 py-3 rounded-xl font-semibold whitespace-nowrap transition-all duration-200 flex items-center gap-2 flex-shrink-0 ${
                                isSelected
                            ...
                            >
                              <div className={`w-1.5 h-1.5 rounded-full ${
                                isSelected ? 'bg-white' : daySchedule.length > 0 ? 'bg-green-500' : 'bg-gray-300'
                              }`}></div>
                        ...
                        {days.filter(day => day !== 'Sunday').map(day => {
                          ...
                          return (
                            <button
                              key={day}
                              onClick={() => setSelectedDay(day)}
                              className={`group px-4 py-3.5 rounded-xl font-semibold text-left transition-all duration-200 flex justify-between items-center ${
                                isSelected
