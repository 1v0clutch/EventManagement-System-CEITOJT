...
export default function RequestEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ 
        type: 'success', 
        text: 'Meeting request submitted successfully! Both Dean and Chairperson must approve before you can create the meeting.' 
      });
      ...
      setMessage({ 
        type: 'error', 
        text: error.response?.data?.message || 'Failed to submit meeting request. Please try again.' 
      });
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-100 to-gray-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-200 font-medium">Request Meeting</p>
              </div>
            </div>
      ...
      <main className="w-full py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Request Meeting</h2>
            <p className="text-lg text-gray-600 font-medium">Submit a request to conduct a meeting. <span className="font-semibold text-blue-700">Both Dean AND Chairperson must approve</span> before you can create the meeting.</p>
            <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800">
                <span className="font-semibold">Note:</span> Faculty and Staff can only request meetings (not events). Events can only be created by Dean, Chairperson, CEIT Official, or Admin.
              </p>
            </div>
          </div>
